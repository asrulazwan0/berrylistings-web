  ...
  return (
    <main className="admin-main" id="main">
      <div className="card" style={{ padding: 'var(--space-6)', maxWidth: 600 }}>
        ...
        <div className="field">
          <label>Role</label>
          <input className="input" value="Admin" readOnly style={{ opacity: 0.7 }} />
        </div>
      </div>
      ...
      <div className="card" style={{ padding: 'var(--space-6)', maxWidth: 600, marginTop: 'var(--space-5)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
          <label className="chip" style={{ cursor: 'pointer' }}><input type="checkbox" disabled style={{ marginRight: 8 }} /> Email notifications for new listings</label>
          <label className="chip" style={{ cursor: 'pointer' }}><input type="checkbox" disabled style={{ marginRight: 8 }} /> Email notifications for inquiries</label>
        </div>
      </div>
    </main>
  );
